...
#let principle = thmbox("principle", "Principio", base_level: 1, fill: rgb("#EFECE6"))

#let theorem = thmbox("theorem", "Teorema", base_level: 1, fill: rgb("#9EDCE1"))
...
#let prop = thmbox("prop", "Proposizione", base_level: 1, fill: rgb("#DAF4EF"))

#let lemma = thmbox("lemma", "Lemma", base_level: 1, fill: rgb("#DAF4EF"))
